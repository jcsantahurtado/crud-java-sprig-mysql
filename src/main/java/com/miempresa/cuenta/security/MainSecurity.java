package com.miempresa.cuenta.security;

import com.miempresa.cuenta.security.jwt.JwtEntryPoint;
import com.miempresa.cuenta.security.jwt.JwtTokenFilter;
import com.miempresa.cuenta.security.service.UserDetailsServiceImpl;
...
public class MainSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                .authorizeRequests()
                .antMatchers("/auth/**", "/*.html", "/**/*.css", "/**/*.js").permitAll()
